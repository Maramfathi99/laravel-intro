...
<form method='post'  enctype='multipart/form-data' action='{{route("employess-model.index")}}'>
    @csrf
    <div class="row">
        <div class="col-md-6 mb-3">
            <label for="firstName">First Name: </label>
            <input autofocus='true' value='{{ old("firstname") }}' type="text" class="form-control" name="firstname" id="firstname" placeholder="Enter Employee First Name">
